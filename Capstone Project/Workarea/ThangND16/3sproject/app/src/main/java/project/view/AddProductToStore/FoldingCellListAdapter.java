...
//            viewHolder.date = cell.findViewById(R.id.title_date_label);
        ...
        viewHolder.productName_content.setText(item.getProductName());
        viewHolder.productBrand_content.setText(item.getBrandName());
        viewHolder.productCategory_content.setText(item.getCategoryName());
        viewHolder.productDesc.setText(item.getDescription());
        viewHolder.productName_title.setText(item.getProductName());
        viewHolder.productBrand.setText(item.getBrandName());
        viewHolder.requestBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                puttedProductList.add(new Item("Nước giải khát Mirinda ","Đồ uống","Pepsi.Co","ảnh mirinda","Đạt ngu như chó"));
