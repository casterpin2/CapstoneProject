...
public class ChildAdapter extends BaseExpandableListAdapter {
    ...
    long total = 0 ;
    //long quantityLong = (long) quantity;
    ...
    public View getGroupView(int groupPosition, boolean b, View convertView, ViewGroup viewGroup) {
        String companyName = ((Cart) getGroup(groupPosition)).getStoreName();
        total += totalProduct;
        if (convertView == null) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        final String deviceName = ((CartDetail) getChild(groupPosition, childPosition)).getProductName();
        final int quantity = ((CartDetail) getChild(groupPosition, childPosition)).getQuantity();
        final String image_path = ((CartDetail) getChild(groupPosition, childPosition)).getImage_path();
        price = ((CartDetail) getChild(groupPosition, childPosition)).getUnitPrice();
        ...
        TextView productName = (TextView) convertView.findViewById(R.id.device_name);
        productName.setText(deviceName);
