...
public class Regex {
    ...
    private static final String NAME_PATTERN = "^[a-zA-ZáàạãảắằặẵẳấầậẫẩéèẹẽẻếềệễểíìịĩỉóòọõỏốồộỗổớờợỡởúùụũủứừựữửýỳỵỹỷÁÀẠÃẢẮẰẶẴẲẤẦẬẪẨÉÈẸẼẺẾỀỆỄỂÍÌỊĨỈÓÒỌÕỎỐỒỘỖỔỚỜỢỠỞÚÙỤŨỦỨỪỰỮỬÝỲỴỸỶ\\s._-]{6,30}$";
